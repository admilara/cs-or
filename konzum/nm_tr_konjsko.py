# -*- coding: utf-8 -*-
"""
Created on Tue Jun 10 15:17:17 2025
...
df_kon_tr = df_kon_tr.dropna(axis = 1, how = 'all')
...
for df in dfs:
    ...
    otocni_rad = [("2024-12-04 09:12:58", "HE ZAK 110 METERIZE/2", "2024-12-04 10:20:29", "HE ZAK 110 SP W12", "AT3 KONJSKO"),
                  ("2024-12-04 11:48:26", "HE ZAK 110 METERIZE/2", "2024-12-04 12:47:14", "HE ZAK 110 SP W12", "AT3 KONJSKO"),
                  ("2024-12-04 14:24:28", "HE ZAK 110 METERIZE/2", "2024-12-04 15:25:27", "HE ZAK 110 SP W12", "AT3 KONJSKO"),
                  ("2024-12-04 16:27:27", "HE ZAK 110 METERIZE/2", "2024-12-04 17:03:18", "HE ZAK 220 SP W12", "AT3 KONJSKO")]
    
    signals = ["konjsko_220/110_atr3_položaj_reg_sklopke"]
    gens = ["A", "D", "B", "C"]
    ...
    titles = ["položaj reg sklopke at3 - otočni rad agr A",
              "položaj reg sklopke at3 - otočni rad agr D", 
              "položaj reg sklopke at3 - otočni rad agr B",
              "položaj reg sklopke at3 - otočni rad agr C"]
    rows = [1,1,2,2]
    cols = [1,2,1,2]
    ...
    filename = "otocni-rad-polozaj-konjsko.html"
