...
# Save the HTML page
with open("ts-sinj-or-gen-a.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as ts-sinj-or-gen-a.html")
...
# Save the HTML page
with open("ts-sinj-or-gen-d.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as ts-sinj-or-gen-d.html")
...
# Save the HTML page
with open("ts-sinj-or-gen-b.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as ts-sinj-or-gen-b.html")
...
# Save the HTML page
with open("ts-sinj-or-gen-c.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as ts-sinj-or-gen-c.html")