# -*- coding: utf-8 -*-
"""
Created on Tue Dec 10 23:31:11 2024
...
konzum_path = "D:\\3_RADNO\\_HOPS\\2_ZAKUCAC_CS_OP\\HOPS\\mjerenja\\konzum\\TS_VRB_TR1_TR2_20241204_0910-1710.csv"
...
units = ["položaj reg. sklopke", "položaj reg. sklopke", "I [A]", "P [MW]", "Q [Mvar]", "U [kV]", 
         "I [A]", "P [MW]", "Q [Mvar]", "U [kV]"]
colors = ["black", "blue", "red", "red", "red", "green", "blue", "blue", "blue", "orange"]
...
<html>
<head>
    <title>konzum-vrboran-OR-A</title>
    <script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
</head>
<body>
    <h1>HOPS NM - mjerenja konzuma - TS 110/35 kV Vrboran</h1>
...
# Save the HTML page
with open("TS_Vrboran_OR_GEN_A.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as TS_Vrboran_OR_GEN_A.html")
...
<html>
<head>
    <title>konzum-vrboran-OR-D</title>
    <script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
</head>
<body>
    <h1>HOPS NM - mjerenja konzuma - TS 110/35 kV Vrboran</h1>
...
# Save the HTML page
with open("TS_Vrboran_OR_GEN_D.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as TS_Vrboran_OR_GEN_D.html")
...
<html>
<head>
    <title>konzum-vrboran-OR-B</title>
    <script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
</head>
<body>
    <h1>HOPS NM - mjerenja konzuma - TS 110/35 kV Vrboran</h1>
...
# Save the HTML page
with open("TS_Vrboran_OR_GEN_B.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as TS_Vrboran_OR_GEN_B.html")
...
<html>
<head>
    <title>konzum-vrboran-OR-C</title>
    <script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
</head>
<body>
    <h1>HOPS NM - mjerenja konzuma - TS 110/35 kV Vrboran</h1>
...
# Save the HTML page
with open("TS_Vrboran_OR_GEN_C.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as TS_Vrboran_OR_GEN_C.html")
