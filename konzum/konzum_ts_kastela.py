...
def graf(df, name, value_column, yaxis_name, colour, otocni_rad):
    ...
    #max_index = df[value_column].idxmax()
    #min_value = df[value_column].min()
    #min_index = df[value_column].idxmin()
...
konzum_path = "D:\\3_RADNO\\_HOPS\\2_ZAKUCAC_CS_OP\\HOPS\\mjerenja\\konzum\\TS_KAST_TR2_20241204_0910-1710.csv"
...
<html>
<head>
    <title>konzum-kastela-OR-A</title>
    <script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
</head>
<body>
    <h1>HOPS NM - mjerenja konzuma - TP2 110/35 kV TS Kaštela</h1>
...
# Save the HTML page
with open("TS_Kastela_TR2_OR_gen_A.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as TS_Kastela_TR2_OR_gen_A.html")
...
<html>
<head>
    <title>konzum-kastela-OR-D</title>
    <script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
</head>
<body>
    <h1>HOPS NM - mjerenja konzuma - TP2 110/35 kV TS Kaštela</h1>
...
# Save the HTML page
with open("TS_Kastela_TR2_OR_gen_D.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as TS_Kastela_TR2_OR_gen_D.html")
...
<html>
<head>
    <title>konzum-kastela-OR-B</title>
    <script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
</head>
<body>
    <h1>HOPS NM - mjerenja konzuma - TP2 110/35 kV TS Kaštela</h1>
...
# Save the HTML page
with open("TS_Kastela_TR2_OR_gen_B.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as TS_Kastela_TR2_OR_gen_B.html")
...
<html>
<head>
    <title>konzum-kastela-OR-C</title>
    <script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
</head>
<body>
    <h1>HOPS NM - mjerenja konzuma - TP2 110/35 kV TS Kaštela</h1>
...
# Save the HTML page
with open("TS_Kastela_TR2_OR_gen_C.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as TS_Kastela_TR2_OR_gen_C.html")