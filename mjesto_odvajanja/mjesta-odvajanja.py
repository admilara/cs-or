...
<body>
    <h1>Mjesto odvajanja: DV 110 kV HE Zakučac - Meterize II</h1>
    <h1>Agregat A</h1>
    <div>{html_list[0]}</div>
    <div>{html_list[1]}</div>
    <div>{html_list[2]}</div>
...
# Save the HTML page
with open("mjesto-odvajanja-gen-a.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as mjesto-odvajanja-gen-a.html")
...
# Save the HTML page
with open("mjesto-odvajanja-gen-d.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as mjesto-odvajanja-gen-d.html")
...
# Save the HTML page
with open("mjesto-odvajanja-gen-b.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as mjesto-odvajanja-gen-b.html")
...
# Save the HTML page
with open("mjesto-odvajanja-gen-c.html", "w") as f:
    f.write(html_page)

print("Dashboard saved as mjesto-odvajanja-gen-c.html")
